...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color secondary = const Color(0xFF2FC31F);
  late Color tertiary = const Color(0xFFEE8B60);
  late Color alternate = const Color(0xFFDABE16);
  ...
  late Color warning = const Color(0xFFC69A1B);
  late Color error = const Color(0xFFA6161F);
